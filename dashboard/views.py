...
def home(request):
    ...
    context = {
        ...
        'lista_gestos': lista_gestos,  # <-- passando a lista para o template
    }
    ...
    def post(self, request):
        try:
            ...
            try:
                ...
                return render(request, 'home2.html', {'erro': 'Conta não encontrada.'})
            amazon_id = conta.amazon_user_id
            dynamodb = boto3.resource('dynamodb', region_name='us-east-1')  # ajuste a região
            table = dynamodb.Table('SmartHomeVirtualButtonsPython')  # coloque o nome certo
